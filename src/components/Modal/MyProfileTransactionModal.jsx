...
const MyProfileTransactionModal = ({ isOpen, onClose }) => {
                                                ...
                                                {transactions.length > 0 ? (
                                                    transactions.map((transaction, index) => (
                                                        <tr key={transaction.id || index} className={`${index % 2 === 0 ? "odd" : "even"}`}>
                                                            ...
                                                            <td className="text-center">{formatBalance(transaction.to_current_balance)}</td>
                                                            <td className="text-center">{formatBalance(transaction.to_new_balance)}</td>
                                                        </tr>
                                                    ))
                                                ) : (
                                                    <tr>
...
export default MyProfileTransactionModal;