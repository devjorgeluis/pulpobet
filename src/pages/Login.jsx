            ...
            <form method="POST" className="sign-in-mobile" onSubmit={handleSubmit}>
                <div className="sign-in-mobile__back"  onClick={() => navigate("/home")}>
                    <span className="SVGInline sign-in-mobile__arrow">
                        <i className="fas fa-chevron-left mr-1 text-white"></i>
                    </span>
                    <span className="sign-in-mobile__back-text">ENTRAR</span>
                </div>
                <div className="sign-in-mobile__form">
                    <div className="sign-in-mobile__fields">
                        <div className="sign-in-mobile__field">
                            <span className="sign-in-mobile__label">Usuario<span className="sign-in-mobile__star">*</span></span>
                    ...
                    <div className="sign-in-mobile__button">
                        ...
                        >
                            <span className="sign-in-mobile__button-text">ENTRAR</span>
                        </button>
                    </div>
                </div>
            </form>
